...
| redis-replication.redisReplication.readinessProbe.failureThreshold | int | `2` |  |
| redis-replication.redisReplication.readinessProbe.initialDelaySeconds | int | `10` |  |
| redis-replication.redisReplication.readinessProbe.periodSeconds | int | `10` |  |
| redis-replication.redisReplication.readinessProbe.successThreshold | int | `2` |  |
| redis-replication.redisReplication.readinessProbe.timeoutSeconds | int | `1` |  |
| redis-replication.redisReplication.service.additional.enabled | bool | `false` |  |
| redis-replication.redisReplication.tag | string | `"v8.4.0"` |  |
...
| redis-sentinel.readinessProbe.failureThreshold | int | `2` |  |
| redis-sentinel.readinessProbe.initialDelaySeconds | int | `10` |  |
| redis-sentinel.readinessProbe.periodSeconds | int | `10` |  |
| redis-sentinel.readinessProbe.successThreshold | int | `2` |  |
...
| redis-sentinel.redisSentinel.tag | string | `"v8.4.0"` |  |
| redis-sentinel.redisSentinelConfig.announceHostnames | string | `"yes"` |  |
| redis-sentinel.redisSentinelConfig.downAfterMilliseconds | string | `"5000"` |  |
| redis-sentinel.redisSentinelConfig.failoverTimeout | string | `"10000"` |  |
...
| redis.redisStandalone.tag | string | `"v8.4.0"` |  |
