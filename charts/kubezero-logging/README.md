...
| vector.extraVolumeMounts[1].mountPath | string | `"/etc/vector-secrets/opensearch"` |  |
| vector.extraVolumeMounts[1].name | string | `"opensearch-creds"` |  |
| vector.extraVolumeMounts[1].readOnly | bool | `true` |  |
| vector.extraVolumeMounts[2].mountPath | string | `"/etc/vector-secrets/remote"` |  |
| vector.extraVolumeMounts[2].name | string | `"remote-token"` |  |
| vector.extraVolumeMounts[2].readOnly | bool | `true` |  |
| vector.extraVolumes[0].name | string | `"http-tokens"` |  |
| vector.extraVolumes[0].secret.secretName | string | `"vector-http-tokens"` |  |
| vector.extraVolumes[1].name | string | `"opensearch-creds"` |  |
| vector.extraVolumes[1].secret.optional | bool | `true` |  |
| vector.extraVolumes[1].secret.secretName | string | `"vector-opensearch"` |  |
| vector.extraVolumes[2].name | string | `"remote-token"` |  |
| vector.extraVolumes[2].secret.optional | bool | `true` |  |
| vector.extraVolumes[2].secret.secretName | string | `"vector-remote-forward"` |  |
...
| vector.opensearch.buffer.maxSize | int | `268435489` |  |
| vector.opensearch.buffer.type | string | `"disk"` |  |
| vector.opensearch.endpoint | string | `"https://opensearch-cluster-master:9200"` |  |
| vector.persistence.enabled | bool | `true` |  |
| vector.persistence.size | string | `"4Gi"` |  |
...
| vector.resources.requests.memory | string | `"192Mi"` |  |
