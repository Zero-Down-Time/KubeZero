...
![Version: 0.4.10](https://img.shields.io/badge/Version-0.4.10-informational?style=flat-square)
...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argo-cd | 10.1.2 |
| https://argoproj.github.io/argo-helm | argo-events | 2.4.22 |
| https://argoproj.github.io/argo-helm | argocd-image-updater | 1.2.4 |
...
| argo-cd.global.image.tag | string | `"v3.4.4"` |  |
...
| argo-events.configs.jetstream.versions[0].configReloaderImage | string | `"natsio/nats-server-config-reloader:0.23.0"` |  |
| argo-events.configs.jetstream.versions[0].metricsExporterImage | string | `"natsio/prometheus-nats-exporter:0.20.1"` |  |
| argo-events.configs.jetstream.versions[0].natsImage | string | `"nats:2.14.3-scratch"` |  |
