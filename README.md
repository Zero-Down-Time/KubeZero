...
Any 1.33.X-Y release of Kubezero supports any Kubernetes cluster 1.33.X.
...
gantt
    ...
    section 1.35
    beta     :135b, 2026-05-12, 2026-06-30
    release  :after 135b, 2026-11-30
```
...
## OS
- all compute nodes are running on Alpine V3.23
